# Generated by Django 4.2.6 on 2023-11-06 04:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('available_till', models.DateField(default=datetime.date(2023, 11, 6))),
            ],
        ),
        migrations.CreateModel(
            name='CarReservation',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.CharField(max_length=100)),
                ('duration_hours', models.PositiveIntegerField(blank=True, null=True)),
                ('cruise_type', models.CharField(blank=True, max_length=100)),
                ...
                ('departure_schedule', models.CharField(blank=True, max_length=100)),
                ('special_events', models.TextField(blank=True)),
                ('inclusions', models.TextField(blank=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('available_from', models.DateField(default=datetime.date(2023, 11, 6))),
                ('available_to', models.DateField(default=datetime.date(2023, 11, 6))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('departure', models.DateField(default=datetime.date(2023, 11, 6))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('operating_season', models.CharField(blank=True, max_length=100)),
        ...
        migrations.CreateModel(
            name='SkyAdventuresImage',
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('image', models.ImageField(upload_to='sky_adventures_images/')),
                ('sky_adventures', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='travel.skyadventures')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sightseeing', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='travel.sightseeing')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            name='GlampingToursImage',
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('image', models.ImageField(upload_to='glamping_tours_images/')),
                ('glamping_tours', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='travel.glampingtours')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            name='DhowCruiseDubaiImage',
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('image', models.ImageField(upload_to='dhow_cruise_dubai_images/')),
                ('dhow_cruise_dubai', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='travel.dhowcruisedubai')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            name='BurjKhalifaToursImage',
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('image', models.ImageField(upload_to='burj_khalifa_tours_images/')),
                ('burj_khalifa_tours', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='travel.burjkhalifatours')),
            ],
        ),
        migrations.CreateModel(
            name='Booking',
